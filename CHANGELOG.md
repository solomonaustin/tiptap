...
- f28cf6d: Keep mixed JSX children as separate siblings in DOM output.
- @tiptap/pm@3.30.2
...
- f28cf6d: Fix resizable images staying hidden when the image is cached or fails to load.
- Updated dependencies [f28cf6d]
  - @tiptap/core@3.30.2
